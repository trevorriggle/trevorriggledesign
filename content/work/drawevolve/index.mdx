...
#
# THE ALT BELOW STILL DESCRIBES THE OLD PICTURE and is the one thing here
# waiting on the copy pass. See the note in the report.
cover:
  src: 02.jpg
  alt: "DrawEvolve running on an iPad: a cartoon character sketch on the canvas with the AI Feedback panel open beside it, giving an overview and a what's-working breakdown"
  aspect: "2064:2752"
  minWidth: 2064
