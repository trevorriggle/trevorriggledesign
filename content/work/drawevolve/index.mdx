...
#   state <- **Status:**      timeline <- **Timeline:**
...
# Derived from the **Timeline:** line above ("October 2025 – present"), not
# supplied as a year by the copy. Display label only, nothing sorts on it.
year: "2025–26"
