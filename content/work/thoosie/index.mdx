...
# public/media/thoosie/thoosiecoaster.mp4 and it takes over with no edit here.
#
# The hero clip is thoosiecoaster.mp4, the filename it carries in the source
# drop. The poster below keeps the stem it is declared with; if the still that
# arrives with the clip is named differently, this one line is the only edit.
video:
